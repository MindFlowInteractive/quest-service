...
export class StellarService {
  ...
  constructor(private configService: ConfigService) {
    ...
    if (secretKey) {
      ...
      this.logger.warn('STELLAR_SECRET_KEY not provided. StellarService will be unable to sign transactions.');
    }
  }
  ...
  async getTokenBalance(accountId: string, tokenContractId: string) {
    try {

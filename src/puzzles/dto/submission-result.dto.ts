...
export class SubmissionResultDto {
  ...
  @ApiProperty({
    ...
    example: SolutionAttemptStatus.CORRECT,
  })
  ...
  @ApiProperty({
    description:
      'Elapsed time in seconds between when the puzzle was started and when it was submitted.',
    example: 45,
  })
  ...
  @ApiPropertyOptional({
    description:
      'Human-readable explanation of why the submission was rejected.',

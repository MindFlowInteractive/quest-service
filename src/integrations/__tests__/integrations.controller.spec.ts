...
describe('IntegrationsController', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: TwitterService, useValue: {} },
        {
          ...
          useValue: {
            notifyAchievement: jest
              .fn()
              .mockResolvedValue({ discord: { success: true } }),
  ...
  describe('shareAchievement', () => {
    it('should share an achievement through the notification service', async () => {
      ...
      expect(
        integrationNotificationService.notifyAchievement,
  ...
  describe('handleDiscordWebhook', () => {
    ...
    it('should reject invalid signatures', async () => {
      ...
      await expect(
        controller.handleDiscordWebhook({ type: 2 }, 'bad-sig', 'timestamp'),
      ).rejects.toThrow(BadRequestException);
    });
  });

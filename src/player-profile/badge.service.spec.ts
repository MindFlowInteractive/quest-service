...
describe('BadgeService', () => {
  ...
  describe('getBadgeById', () => {
    ...
    it('should throw NotFoundException for invalid ID', () => {
      expect(() => service.getBadgeById('non-existent')).toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('getBadgesByCategory', () => {
    it('should return badges by category', () => {
      const achievementBadges = service.getBadgesByCategory(
        BadgeCategory.ACHIEVEMENT,
      );

      expect(achievementBadges.length).toBeGreaterThan(0);
      expect(
        achievementBadges.every(
    ...
    it('should return skill badges', () => {
      ...
      expect(
        skillBadges.every((badge) => badge.category === BadgeCategory.SKILL),
      ).toBe(true);
    });
  });
  ...
  describe('getBadgesByRarity', () => {
    ...
    it('should return legendary badges', () => {
      ...
      expect(
        legendaryBadges.every((badge) => badge.rarity === 'legendary'),
      ).toBe(true);
    });
  });
  ...
  describe('updateBadge', () => {
    ...
    it('should throw NotFoundException for non-existent badge', () => {
      expect(() =>
        service.updateBadge('non-existent', { name: 'Test' }),
  ...
  describe('removeBadge', () => {
    it('should remove existing badge', () => {
      ...
      expect(() => service.getBadgeById('removable-badge')).toThrow(
        NotFoundException,
      );
    });

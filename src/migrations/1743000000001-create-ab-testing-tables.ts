...
export class CreateAbTestingTables1743000000001 implements MigrationInterface {
  name = 'CreateAbTestingTables1743000000001';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CREATE INDEX idx_experiment_conversions_experiment_id ON experiment_conversions(experiment_id);
      CREATE INDEX idx_experiment_conversions_user_id ON experiment_conversions(user_id);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS experiment_conversions`);

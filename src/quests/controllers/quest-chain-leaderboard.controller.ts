...
export class QuestChainLeaderboardController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Speed run leaderboard retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Score leaderboard retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Total completions leaderboard retrieved successfully',
  })

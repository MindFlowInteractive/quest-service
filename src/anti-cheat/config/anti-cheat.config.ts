...
export default registerAs(
  ...
  (): AntiCheatConfig => ({
    ...
    thresholds: {
      minimumMoveTime: parseInt(
        process.env.ANTI_CHEAT_MIN_MOVE_TIME || '100',
        10,
      ),
      impossiblyFastThreshold: parseInt(
        process.env.ANTI_CHEAT_FAST_THRESHOLD || '150',
        10,
      ),
      maxFastMoveRatio: parseFloat(
        process.env.ANTI_CHEAT_MAX_FAST_MOVE_RATIO || '0.8',
      ),
      minTimingVariance: parseFloat(
        process.env.ANTI_CHEAT_MIN_TIMING_VARIANCE || '50',
      ),
      roboticConsistencyThreshold: parseFloat(
        process.env.ANTI_CHEAT_ROBOTIC_THRESHOLD || '30',
      ),
      suspiciousAccuracyThreshold: parseFloat(
        process.env.ANTI_CHEAT_SUSPICIOUS_ACCURACY || '0.95',
      ),
      perfectAccuracyMinMoves: parseInt(
        process.env.ANTI_CHEAT_PERFECT_ACCURACY_MIN_MOVES || '15',
        10,
      ),
      zScoreThreshold: parseFloat(
        process.env.ANTI_CHEAT_Z_SCORE_THRESHOLD || '3.0',
      ),
      populationSampleSize: parseInt(
        process.env.ANTI_CHEAT_POPULATION_SAMPLE || '100',
        10,
      ),
      patternSimilarityThreshold: parseFloat(
        process.env.ANTI_CHEAT_PATTERN_SIMILARITY || '0.9',
      ),
      minPatternsForComparison: parseInt(
        process.env.ANTI_CHEAT_MIN_PATTERNS || '3',
        10,
      ),
      maxMovesPerSecond: parseInt(
        process.env.ANTI_CHEAT_MAX_MOVES_PER_SECOND || '10',
        10,
      ),
      maxPuzzlesPerMinute: parseInt(
        process.env.ANTI_CHEAT_MAX_PUZZLES_PER_MINUTE || '5',
        10,
      ),
      initialTrustScore: parseInt(
        process.env.ANTI_CHEAT_INITIAL_TRUST_SCORE || '100',
        10,
      ),
      minTrustScore: parseInt(
        process.env.ANTI_CHEAT_MIN_TRUST_SCORE || '0',
        10,
      ),
      ...
      trustRecoveryRate: parseFloat(
        process.env.ANTI_CHEAT_TRUST_RECOVERY || '1.0',
      ),
    },
    ...
    actions: {
      ...
      autoBlockThreshold: parseInt(
        process.env.ANTI_CHEAT_AUTO_BLOCK_THRESHOLD || '3',
        10,
      ),
      tempBanDuration: parseInt(
        process.env.ANTI_CHEAT_TEMP_BAN_DURATION || '24',
        10,
      ),
      actionTiers: {
    ...
    analysis: {
      ...
      batchAnalysisInterval: parseInt(
        process.env.ANTI_CHEAT_BATCH_INTERVAL || '300',
        10,
      ),
      behaviorProfileUpdateFrequency: parseInt(
        process.env.ANTI_CHEAT_PROFILE_UPDATE_FREQ || '10',
        10,
      ),
      statisticalAnalysisEnabled:
        process.env.ANTI_CHEAT_STATISTICAL_ANALYSIS !== 'false',
      crossSessionAnalysisEnabled:
        process.env.ANTI_CHEAT_CROSS_SESSION_ANALYSIS !== 'false',
    },
    ...
    shadowMode: {
      ...
      createViolations:
        process.env.ANTI_CHEAT_SHADOW_CREATE_VIOLATIONS !== 'false',
    ...
    appeals: {
      ...
      autoApprovalForLowSeverity:
        process.env.ANTI_CHEAT_AUTO_APPROVE_LOW === 'true',
      maxAppealsPerViolation: parseInt(
        process.env.ANTI_CHEAT_MAX_APPEALS || '1',
        10,
      ),
    ...
    reporting: {
      ...
      minReportsForAutoInvestigation: parseInt(
        process.env.ANTI_CHEAT_MIN_REPORTS_AUTO || '3',
        10,
      ),
      reportVotingEnabled: process.env.ANTI_CHEAT_REPORT_VOTING !== 'false',
      duplicateReportWindow: parseInt(
        process.env.ANTI_CHEAT_DUPLICATE_WINDOW || '7',
        10,
      ),
    },

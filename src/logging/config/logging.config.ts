      ...
      rules: {
        errorRate: {
          threshold: Number.parseFloat(
            process.env.ALERTING_ERROR_RATE_THRESHOLD || '0.05',
          ),
          window: Number.parseInt(
            process.env.ALERTING_ERROR_RATE_WINDOW || '300000',
          ),
        },
        responseTime: {
          threshold: Number.parseInt(
            process.env.ALERTING_RESPONSE_TIME_THRESHOLD || '2000',
          ),
          window: Number.parseInt(
            process.env.ALERTING_RESPONSE_TIME_WINDOW || '300000',
          ),
        },
        memoryUsage: {
          threshold: Number.parseFloat(
            process.env.ALERTING_MEMORY_THRESHOLD || '0.85',
          ),
          window: Number.parseInt(
            process.env.ALERTING_MEMORY_WINDOW || '300000',
          ),
        },
      },
    },

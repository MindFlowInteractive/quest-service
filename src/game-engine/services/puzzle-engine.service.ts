  ...
  async createPuzzle(
    ...
    if (!energyResult.success) {
      throw new BadRequestException(
        `Insufficient energy. Need ${energyCost}, have ${
          energyResult.currentEnergy
        }. Next regeneration at ${energyResult.nextRegenerationAt.toISOString()}`,
      );
    }
